...
struct _g final : public ::faust::dsp {
	...
	void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		float fSlow16 = float(16.0f < fSlow0);
		float fSlow17 = float(18.0f < fSlow0);
		float fSlow18 = float(2e+01f < fSlow0);
		float fSlow19 = float(22.0f < fSlow0);
		float fSlow20 = float(24.0f < fSlow0);
		float fSlow21 = float(26.0f < fSlow0);
		float fSlow22 = float(28.0f < fSlow0);
		float fSlow23 = float(3e+01f < fSlow0);
		float fSlow24 = float(32.0f < fSlow0);
		float fSlow25 = float(34.0f < fSlow0);
		float fSlow26 = float(36.0f < fSlow0);
		float fSlow27 = float(38.0f < fSlow0);
		float fSlow28 = float(4e+01f < fSlow0);
		float fSlow29 = float(42.0f < fSlow0);
		float fSlow30 = float(44.0f < fSlow0);
		float fSlow31 = float(46.0f < fSlow0);
		float fSlow32 = float(48.0f < fSlow0);
		float fSlow33 = float(5e+01f < fSlow0);
		float fSlow34 = float(52.0f < fSlow0);
		float fSlow35 = float(54.0f < fSlow0);
		float fSlow36 = float(56.0f < fSlow0);
		float fSlow37 = float(58.0f < fSlow0);
		float fSlow38 = float(6e+01f < fSlow0);
		float fSlow39 = float(62.0f < fSlow0);
		float fSlow40 = float(1.0f < fSlow0);
		float fSlow41 = float(3.0f < fSlow0);
		float fSlow42 = float(5.0f < fSlow0);
		float fSlow43 = float(7.0f < fSlow0);
		float fSlow44 = float(9.0f < fSlow0);
		float fSlow45 = float(11.0f < fSlow0);
		float fSlow46 = float(13.0f < fSlow0);
		float fSlow47 = float(15.0f < fSlow0);
		float fSlow48 = float(17.0f < fSlow0);
		float fSlow49 = float(19.0f < fSlow0);
		float fSlow50 = float(21.0f < fSlow0);
		float fSlow51 = float(23.0f < fSlow0);
		float fSlow52 = float(25.0f < fSlow0);
		float fSlow53 = float(27.0f < fSlow0);
		float fSlow54 = float(29.0f < fSlow0);
		float fSlow55 = float(31.0f < fSlow0);
		float fSlow56 = float(33.0f < fSlow0);
		float fSlow57 = float(35.0f < fSlow0);
		float fSlow58 = float(37.0f < fSlow0);
		float fSlow59 = float(39.0f < fSlow0);
		float fSlow60 = float(41.0f < fSlow0);
		float fSlow61 = float(43.0f < fSlow0);
		float fSlow62 = float(45.0f < fSlow0);
		float fSlow63 = float(47.0f < fSlow0);
		float fSlow64 = float(49.0f < fSlow0);
		float fSlow65 = float(51.0f < fSlow0);
		float fSlow66 = float(53.0f < fSlow0);
		float fSlow67 = float(55.0f < fSlow0);
		float fSlow68 = float(57.0f < fSlow0);
		float fSlow69 = float(59.0f < fSlow0);
		float fSlow70 = float(61.0f < fSlow0);
		float fSlow71 = float(63.0f < fSlow0);
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			iRec4[0] = 1103515245 * (iTemp64 + 12345);
			int iRec5 = iTemp64;
			int iRec6 = iTemp63;
			int iRec7 = iTemp62;
			int iRec8 = iTemp61;
