...
struct _g final : public ::faust::dsp {
	...
	void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		float fSlow9 = float(2e+01f < fSlow0);
		float fSlow10 = float(22.0f < fSlow0);
		float fSlow11 = float(24.0f < fSlow0);
		float fSlow12 = float(14.0f < fSlow0);
		float fSlow13 = float(16.0f < fSlow0);
		float fSlow14 = float(18.0f < fSlow0);
		float fSlow15 = float(8.0f < fSlow0);
		float fSlow16 = float(1e+01f < fSlow0);
		float fSlow17 = float(12.0f < fSlow0);
		float fSlow18 = float(2.0f < fSlow0);
		float fSlow19 = float(4.0f < fSlow0);
		float fSlow20 = float(6.0f < fSlow0);
		float fSlow21 = float(44.0f < fSlow0);
		float fSlow22 = float(46.0f < fSlow0);
		float fSlow23 = float(48.0f < fSlow0);
		float fSlow24 = float(38.0f < fSlow0);
		float fSlow25 = float(4e+01f < fSlow0);
		float fSlow26 = float(42.0f < fSlow0);
		float fSlow27 = float(32.0f < fSlow0);
		float fSlow28 = float(34.0f < fSlow0);
		float fSlow29 = float(36.0f < fSlow0);
		float fSlow30 = float(26.0f < fSlow0);
		float fSlow31 = float(28.0f < fSlow0);
		float fSlow32 = float(3e+01f < fSlow0);
		float fSlow33 = float(56.0f < fSlow0);
		float fSlow34 = float(58.0f < fSlow0);
		float fSlow35 = float(6e+01f < fSlow0);
		float fSlow36 = float(62.0f < fSlow0);
		float fSlow37 = float(5e+01f < fSlow0);
		float fSlow38 = float(52.0f < fSlow0);
		float fSlow39 = float(54.0f < fSlow0);
		float fSlow40 = float(63.0f < fSlow0);
		float fSlow41 = float(43.0f < fSlow0);
		float fSlow42 = float(41.0f < fSlow0);
		float fSlow43 = float(39.0f < fSlow0);
		float fSlow44 = float(49.0f < fSlow0);
		float fSlow45 = float(47.0f < fSlow0);
		float fSlow46 = float(45.0f < fSlow0);
		float fSlow47 = float(55.0f < fSlow0);
		float fSlow48 = float(53.0f < fSlow0);
		float fSlow49 = float(51.0f < fSlow0);
		float fSlow50 = float(61.0f < fSlow0);
		float fSlow51 = float(57.0f < fSlow0);
		float fSlow52 = float(59.0f < fSlow0);
		float fSlow53 = float(7.0f < fSlow0);
		float fSlow54 = float(9.0f < fSlow0);
		float fSlow55 = float(11.0f < fSlow0);
		float fSlow56 = float(1.0f < fSlow0);
		float fSlow57 = float(3.0f < fSlow0);
		float fSlow58 = float(5.0f < fSlow0);
		float fSlow59 = float(33.0f < fSlow0);
		float fSlow60 = float(35.0f < fSlow0);
		float fSlow61 = float(37.0f < fSlow0);
		float fSlow62 = float(27.0f < fSlow0);
		float fSlow63 = float(29.0f < fSlow0);
		float fSlow64 = float(31.0f < fSlow0);
		float fSlow65 = float(19.0f < fSlow0);
		float fSlow66 = float(21.0f < fSlow0);
		float fSlow67 = float(23.0f < fSlow0);
		float fSlow68 = float(25.0f < fSlow0);
		float fSlow69 = float(13.0f < fSlow0);
		float fSlow70 = float(15.0f < fSlow0);
		float fSlow71 = float(17.0f < fSlow0);
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			int iRec65 = iTemp2;
			int iRec66 = iTemp1;
			int iTemp64 = int(fSlow7 * (1.0f - float(iRec3[0])));
			int iTemp65 = 1 - iVec0[1];
			iRec2[0] = iTemp64 * iTemp65 + iRec2[1] * iVec0[1];
			...
			int iTemp69 = int(fSlow7 * (1.0f - float(iRec23)));
			iRec69[0] = iTemp69 * iTemp65 + iRec69[1] * iVec0[1];
			...
			int iTemp73 = int(fSlow7 * (1.0f - float(iRec25)));
			...
			int iTemp77 = int(fSlow7 * (1.0f - float(iRec27)));
			...
			int iTemp81 = int(fSlow7 * (1.0f - float(iRec17)));
			...
			iRec74[0] = iRec74[1] * (1 - iTemp84) + iTemp84 * iTemp81;
			int iTemp85 = int(fSlow7 * (1.0f - float(iRec19)));
			iRec77[0] = iRec77[1] * iVec0[1] + iTemp85 * iTemp65;
			int iTemp86 = (iRec67[0] + iRec77[0]) % iSlow4;
			float fTemp87 = float(iTemp86);
			int iTemp88 = int(fSlow6 * fTemp87);
			iRec76[0] = iRec76[1] * (1 - iTemp88) + iTemp85 * iTemp88;
			int iTemp89 = int(fSlow7 * (1.0f - float(iRec21)));
			...
			int iTemp93 = int(fSlow7 * (1.0f - float(iRec11)));
			...
			iRec80[0] = (1 - iTemp96) * iRec80[1] + iTemp96 * iTemp93;
			int iTemp97 = int(fSlow7 * (1.0f - float(iRec13)));
			iRec83[0] = iRec83[1] * iVec0[1] + iTemp97 * iTemp65;
			...
			int iTemp101 = int(fSlow7 * (1.0f - float(iRec15)));
			...
			int iTemp105 = int(fSlow7 * (1.0f - float(iRec5)));
			...
			int iTemp109 = int(fSlow7 * (1.0f - float(iRec7)));
			iRec89[0] = iRec89[1] * iVec0[1] + iTemp109 * iTemp65;
			...
			int iTemp113 = int(fSlow7 * (1.0f - float(iRec9)));
			...
			int iTemp117 = int(fSlow7 * (1.0f - float(iRec47)));
			iRec92[0] = iTemp117 * iTemp65 + iRec92[1] * iVec0[1];
			int iTemp118 = (iRec67[0] + iRec92[0]) % iSlow4;
			float fTemp119 = float(iTemp118);
			int iTemp120 = int(fSlow6 * fTemp119);
			iRec93[0] = iRec93[1] * (1 - iTemp120) + iTemp117 * iTemp120;
			int iTemp121 = int(fSlow7 * (1.0f - float(iRec49)));
			iRec94[0] = iRec94[1] * iVec0[1] + iTemp121 * iTemp65;
			int iTemp122 = (iRec67[0] + iRec94[0]) % iSlow4;
			float fTemp123 = float(iTemp122);
			int iTemp124 = int(fSlow6 * fTemp123);
			iRec95[0] = iRec95[1] * (1 - iTemp124) + iTemp121 * iTemp124;
			int iTemp125 = int(fSlow7 * (1.0f - float(iRec51)));
			iRec96[0] = iRec96[1] * iVec0[1] + iTemp125 * iTemp65;
			int iTemp126 = (iRec67[0] + iRec96[0]) % iSlow4;
			float fTemp127 = float(iTemp126);
			int iTemp128 = int(fSlow6 * fTemp127);
			iRec97[0] = iRec97[1] * (1 - iTemp128) + iTemp125 * iTemp128;
			int iTemp129 = int(fSlow7 * (1.0f - float(iRec41)));
			iRec99[0] = iTemp129 * iTemp65 + iRec99[1] * iVec0[1];
			...
			int iTemp133 = int(fSlow7 * (1.0f - float(iRec43)));
			iRec100[0] = iRec100[1] * iVec0[1] + iTemp133 * iTemp65;
			int iTemp134 = (iRec67[0] + iRec100[0]) % iSlow4;
			float fTemp135 = float(iTemp134);
			int iTemp136 = int(fSlow6 * fTemp135);
			iRec101[0] = iRec101[1] * (1 - iTemp136) + iTemp133 * iTemp136;
			int iTemp137 = int(fSlow7 * (1.0f - float(iRec45)));
			iRec102[0] = iRec102[1] * iVec0[1] + iTemp137 * iTemp65;
			int iTemp138 = (iRec67[0] + iRec102[0]) % iSlow4;
			float fTemp139 = float(iTemp138);
			int iTemp140 = int(fSlow6 * fTemp139);
			iRec103[0] = iRec103[1] * (1 - iTemp140) + iTemp137 * iTemp140;
			int iTemp141 = int(fSlow7 * (1.0f - float(iRec35)));
			iRec105[0] = iTemp141 * iTemp65 + iRec105[1] * iVec0[1];
			...
			int iTemp149 = int(fSlow7 * (1.0f - float(iRec39)));
			...
			int iTemp153 = int(fSlow7 * (1.0f - float(iRec29)));
			...
			int iTemp157 = int(fSlow7 * (1.0f - float(iRec31)));
			...
			int iTemp161 = int(fSlow7 * (1.0f - float(iRec33)));
			...
			int iTemp165 = int(fSlow7 * (1.0f - float(iRec59)));
			iRec116[0] = iRec116[1] * iVec0[1] + iTemp165 * iTemp65;
			int iTemp166 = (iRec67[0] + iRec116[0]) % iSlow4;
			float fTemp167 = float(iTemp166);
			int iTemp168 = int(fSlow6 * fTemp167);
			iRec117[0] = iRec117[1] * (1 - iTemp168) + iTemp165 * iTemp168;
			int iTemp169 = int(fSlow7 * (1.0f - float(iRec61)));
			iRec118[0] = iRec118[1] * iVec0[1] + iTemp169 * iTemp65;
			int iTemp170 = (iRec67[0] + iRec118[0]) % iSlow4;
			float fTemp171 = float(iTemp170);
			int iTemp172 = int(fSlow6 * fTemp171);
			iRec119[0] = iRec119[1] * (1 - iTemp172) + iTemp169 * iTemp172;
			int iTemp173 = int(fSlow7 * (1.0f - float(iRec63)));
			iRec120[0] = iRec120[1] * iVec0[1] + iTemp173 * iTemp65;
			int iTemp174 = (iRec67[0] + iRec120[0]) % iSlow4;
			float fTemp175 = float(iTemp174);
			int iTemp176 = int(fSlow6 * fTemp175);
			iRec121[0] = iRec121[1] * (1 - iTemp176) + iTemp173 * iTemp176;
			int iTemp177 = int(fSlow7 * (1.0f - float(iRec65)));
			iRec122[0] = iRec122[1] * iVec0[1] + iTemp177 * iTemp65;
			int iTemp178 = (iRec67[0] + iRec122[0]) % iSlow4;
			float fTemp179 = float(iTemp178);
			int iTemp180 = int(fSlow6 * fTemp179);
			iRec123[0] = iRec123[1] * (1 - iTemp180) + iTemp177 * iTemp180;
			int iTemp181 = int(fSlow7 * (1.0f - float(iRec53)));
			iRec124[0] = iRec124[1] * iVec0[1] + iTemp181 * iTemp65;
			int iTemp182 = (iRec67[0] + iRec124[0]) % iSlow4;
			float fTemp183 = float(iTemp182);
			int iTemp184 = int(fSlow6 * fTemp183);
			iRec125[0] = iRec125[1] * (1 - iTemp184) + iTemp181 * iTemp184;
			int iTemp185 = int(fSlow7 * (1.0f - float(iRec55)));
			iRec126[0] = iRec126[1] * iVec0[1] + iTemp185 * iTemp65;
			int iTemp186 = (iRec67[0] + iRec126[0]) % iSlow4;
			float fTemp187 = float(iTemp186);
			int iTemp188 = int(fSlow6 * fTemp187);
			iRec127[0] = iRec127[1] * (1 - iTemp188) + iTemp185 * iTemp188;
			int iTemp189 = int(fSlow7 * (1.0f - float(iRec57)));
			...
			output0[i0] = FAUSTFLOAT(fSlow1 * (fSlow2 * ftbl0[std::max<int>(0, std::min<int>((iRec1[0] + iTemp66) % iSlow3, 479999))] * std::sin(fSlow8 * fTemp67) + fSlow9 * ftbl0[std::max<int>(0, std::min<int>((iRec68[0] + iTemp70) % iSlow3, 479999))] * std::sin(fSlow8 * fTemp71) + fSlow10 * ftbl0[std::max<int>(0, std::min<int>((iRec70[0] + iTemp74) % iSlow3, 479999))] * std::sin(fSlow8 * fTemp75) + fSlow11 * ftbl0[std::max<int>(0, std::min<int>((iRec72[0] + iTemp78) % iSlow3, 479999))] * std::sin(fSlow8 * fTemp79) + fSlow12 * ftbl0[std::max<int>(0, std::min<int>((iRec74[0] + iTemp82) % iSlow3, 479999))] * std::sin(fSlow8 * fTemp83) + fSlow13 * ftbl0[std::max<int>(0, std::min<int>((iRec76[0] + iTemp86) % iSlow3, 479999))] * std::sin(fSlow8 * fTemp87) + fSlow14 * ftbl0[std::max<int>(0, std::min<int>((iRec78[0] + iTemp90) % iSlow3, 479999))] * std::sin(fSlow8 * fTemp91) + fSlow15 * ftbl0[std::max<int>(0, std::min<int>((iRec80[0] + iTemp94) % iSlow3, 479999))] * std::sin(fSlow8 * fTemp95) + fSlow16 * ftbl0[std::max<int>(0, std::min<int>((iRec82[0] + iTemp98) % iSlow3, 479999))] * std::sin(fSlow8 * fTemp99) + fSlow17 * ftbl0[std::max<int>(0, std::min<int>((iRec84[0] + iTemp102) % iSlow3, 479999))] * std::sin(fSlow8 * fTemp103) + fSlow18 * ftbl0[std::max<int>(0, std::min<int>((iRec86[0] + iTemp106) % iSlow3, 479999))] * std::sin(fSlow8 * fTemp107) + fSlow19 * ftbl0[std::max<int>(0, std::min<int>((iRec88[0] + iTemp110) % iSlow3, 479999))] * std::sin(fSlow8 * fTemp111) + fSlow20 * ftbl0[std::max<int>(0, std::min<int>((iRec90[0] + iTemp114) % iSlow3, 479999))] * std::sin(fSlow8 * fTemp115) + fSlow21 * ftbl0[std::max<int>(0, std::min<int>((iTemp118 + iRec93[0]) % iSlow3, 479999))] * std::sin(fSlow8 * fTemp119) + fSlow22 * ftbl0[std::max<int>(0, std::min<int>((iTemp122 + iRec95[0]) % iSlow3, 479999))] * std::sin(fSlow8 * fTemp123) + fSlow23 * ftbl0[std::max<int>(0, std::min<int>((iTemp126 + iRec97[0]) % iSlow3, 479999))] * std::sin(fSlow8 * fTemp127) + fSlow24 * ftbl0[std::max<int>(0, std::min<int>((iRec98[0] + iTemp130) % iSlow3, 479999))] * std::sin(fSlow8 * fTemp131) + fSlow25 * ftbl0[std::max<int>(0, std::min<int>((iTemp134 + iRec101[0]) % iSlow3, 479999))] * std::sin(fSlow8 * fTemp135) + fSlow26 * ftbl0[std::max<int>(0, std::min<int>((iTemp138 + iRec103[0]) % iSlow3, 479999))] * std::sin(fSlow8 * fTemp139) + fSlow27 * ftbl0[std::max<int>(0, std::min<int>((iRec104[0] + iTemp142) % iSlow3, 479999))] * std::sin(fSlow8 * fTemp143) + fSlow28 * ftbl0[std::max<int>(0, std::min<int>((iRec106[0] + iTemp146) % iSlow3, 479999))] * std::sin(fSlow8 * fTemp147) + fSlow29 * ftbl0[std::max<int>(0, std::min<int>((iRec108[0] + iTemp150) % iSlow3, 479999))] * std::sin(fSlow8 * fTemp151) + fSlow30 * ftbl0[std::max<int>(0, std::min<int>((iRec110[0] + iTemp154) % iSlow3, 479999))] * std::sin(fSlow8 * fTemp155) + fSlow31 * ftbl0[std::max<int>(0, std::min<int>((iRec112[0] + iTemp158) % iSlow3, 479999))] * std::sin(fSlow8 * fTemp159) + fSlow32 * ftbl0[std::max<int>(0, std::min<int>((iRec114[0] + iTemp162) % iSlow3, 479999))] * std::sin(fSlow8 * fTemp163) + fSlow33 * ftbl0[std::max<int>(0, std::min<int>((iTemp166 + iRec117[0]) % iSlow3, 479999))] * std::sin(fSlow8 * fTemp167) + fSlow34 * ftbl0[std::max<int>(0, std::min<int>((iTemp170 + iRec119[0]) % iSlow3, 479999))] * std::sin(fSlow8 * fTemp171) + fSlow35 * ftbl0[std::max<int>(0, std::min<int>((iTemp174 + iRec121[0]) % iSlow3, 479999))] * std::sin(fSlow8 * fTemp175) + fSlow36 * ftbl0[std::max<int>(0, std::min<int>((iTemp178 + iRec123[0]) % iSlow3, 479999))] * std::sin(fSlow8 * fTemp179) + fSlow37 * ftbl0[std::max<int>(0, std::min<int>((iTemp182 + iRec125[0]) % iSlow3, 479999))] * std::sin(fSlow8 * fTemp183) + fSlow38 * ftbl0[std::max<int>(0, std::min<int>((iTemp186 + iRec127[0]) % iSlow3, 479999))] * std::sin(fSlow8 * fTemp187) + fSlow39 * ftbl0[std::max<int>(0, std::min<int>((iTemp190 + iRec129[0]) % iSlow3, 479999))] * std::sin(fSlow8 * fTemp191)));
			int iTemp193 = int(fSlow7 * (1.0f - float(iRec66)));
			iRec130[0] = iRec130[1] * iVec0[1] + iTemp193 * iTemp65;
			int iTemp194 = (iRec67[0] + iRec130[0]) % iSlow4;
			float fTemp195 = float(iTemp194);
			int iTemp196 = int(fSlow6 * fTemp195);
			iRec131[0] = iRec131[1] * (1 - iTemp196) + iTemp193 * iTemp196;
			int iTemp197 = int(fSlow7 * (1.0f - float(iRec46)));
			iRec132[0] = iRec132[1] * iVec0[1] + iTemp197 * iTemp65;
			int iTemp198 = (iRec67[0] + iRec132[0]) % iSlow4;
			...
			iRec134[0] = iRec134[1] * iVec0[1] + iTemp201 * iTemp65;
			int iTemp202 = (iRec67[0] + iRec134[0]) % iSlow4;
			...
			iRec136[0] = iTemp205 * iTemp65 + iRec136[1] * iVec0[1];
			int iTemp206 = (iRec67[0] + iRec136[0]) % iSlow4;
			float fTemp207 = float(iTemp206);
			int iTemp208 = int(fSlow6 * fTemp207);
			iRec137[0] = iRec137[1] * (1 - iTemp208) + iTemp208 * iTemp205;
			int iTemp209 = int(fSlow7 * (1.0f - float(iRec52)));
			iRec138[0] = iRec138[1] * iVec0[1] + iTemp209 * iTemp65;
			int iTemp210 = (iRec67[0] + iRec138[0]) % iSlow4;
			...
			iRec140[0] = iRec140[1] * iVec0[1] + iTemp213 * iTemp65;
			int iTemp214 = (iRec67[0] + iRec140[0]) % iSlow4;
			...
			iRec142[0] = iRec142[1] * iVec0[1] + iTemp217 * iTemp65;
			int iTemp218 = (iRec67[0] + iRec142[0]) % iSlow4;
			float fTemp219 = float(iTemp218);
			int iTemp220 = int(fSlow6 * fTemp219);
			iRec143[0] = iRec143[1] * (1 - iTemp220) + iTemp220 * iTemp217;
			int iTemp221 = int(fSlow7 * (1.0f - float(iRec58)));
			iRec144[0] = iRec144[1] * iVec0[1] + iTemp221 * iTemp65;
			int iTemp222 = (iRec67[0] + iRec144[0]) % iSlow4;
			...
			iRec146[0] = iRec146[1] * iVec0[1] + iTemp225 * iTemp65;
			int iTemp226 = (iRec67[0] + iRec146[0]) % iSlow4;
			...
			iRec148[0] = iRec148[1] * iVec0[1] + iTemp229 * iTemp65;
			int iTemp230 = (iRec67[0] + iRec148[0]) % iSlow4;
			float fTemp231 = float(iTemp230);
			int iTemp232 = int(fSlow6 * fTemp231);
			iRec149[0] = (1 - iTemp232) * iRec149[1] + iTemp229 * iTemp232;
			int iTemp233 = int(fSlow7 * (1.0f - float(iRec64)));
			iRec150[0] = iRec150[1] * iVec0[1] + iTemp233 * iTemp65;
			int iTemp234 = (iRec67[0] + iRec150[0]) % iSlow4;
			float fTemp235 = float(iTemp234);
			int iTemp236 = int(fSlow6 * fTemp235);
			iRec151[0] = iRec151[1] * (1 - iTemp236) + iTemp233 * iTemp236;
			int iTemp237 = int(fSlow7 * (1.0f - float(iRec60)));
			iRec152[0] = iRec152[1] * iVec0[1] + iTemp237 * iTemp65;
			int iTemp238 = (iRec67[0] + iRec152[0]) % iSlow4;
			float fTemp239 = float(iTemp238);
			int iTemp240 = int(fSlow6 * fTemp239);
			iRec153[0] = iRec153[1] * (1 - iTemp240) + iTemp237 * iTemp240;
			int iTemp241 = int(fSlow7 * (1.0f - float(iRec62)));
			iRec154[0] = iRec154[1] * iVec0[1] + iTemp241 * iTemp65;
			int iTemp242 = (iRec67[0] + iRec154[0]) % iSlow4;
			float fTemp243 = float(iTemp242);
			int iTemp244 = int(fSlow6 * fTemp243);
			iRec155[0] = iRec155[1] * (1 - iTemp244) + iTemp241 * iTemp244;
			int iTemp245 = int(fSlow7 * (1.0f - float(iRec10)));
			iRec156[0] = iTemp245 * iTemp65 + iRec156[1] * iVec0[1];
			int iTemp246 = (iRec67[0] + iRec156[0]) % iSlow4;
			float fTemp247 = float(iTemp246);
			int iTemp248 = int(fSlow6 * fTemp247);
			iRec157[0] = iRec157[1] * (1 - iTemp248) + iTemp245 * iTemp248;
			int iTemp249 = int(fSlow7 * (1.0f - float(iRec12)));
			iRec158[0] = iRec158[1] * iVec0[1] + iTemp249 * iTemp65;
			int iTemp250 = (iRec67[0] + iRec158[0]) % iSlow4;
			float fTemp251 = float(iTemp250);
			int iTemp252 = int(fSlow6 * fTemp251);
			iRec159[0] = iRec159[1] * (1 - iTemp252) + iTemp249 * iTemp252;
			int iTemp253 = int(fSlow7 * (1.0f - float(iRec14)));
			iRec160[0] = iRec160[1] * iVec0[1] + iTemp253 * iTemp65;
			int iTemp254 = (iRec67[0] + iRec160[0]) % iSlow4;
			float fTemp255 = float(iTemp254);
			int iTemp256 = int(fSlow6 * fTemp255);
			iRec161[0] = iRec161[1] * (1 - iTemp256) + iTemp253 * iTemp256;
			int iTemp257 = int(fSlow7 * (1.0f - float(iRec4)));
			iRec162[0] = iRec162[1] * iVec0[1] + iTemp257 * iTemp65;
			int iTemp258 = (iRec67[0] + iRec162[0]) % iSlow4;
			float fTemp259 = float(iTemp258);
			int iTemp260 = int(fSlow6 * fTemp259);
			iRec163[0] = iRec163[1] * (1 - iTemp260) + iTemp257 * iTemp260;
			int iTemp261 = int(fSlow7 * (1.0f - float(iRec6)));
			iRec164[0] = iRec164[1] * iVec0[1] + iTemp261 * iTemp65;
			int iTemp262 = (iRec67[0] + iRec164[0]) % iSlow4;
			float fTemp263 = float(iTemp262);
			int iTemp264 = int(fSlow6 * fTemp263);
			iRec165[0] = iRec165[1] * (1 - iTemp264) + iTemp261 * iTemp264;
			int iTemp265 = int(fSlow7 * (1.0f - float(iRec8)));
			iRec166[0] = iRec166[1] * iVec0[1] + iTemp265 * iTemp65;
			int iTemp266 = (iRec67[0] + iRec166[0]) % iSlow4;
			float fTemp267 = float(iTemp266);
			int iTemp268 = int(fSlow6 * fTemp267);
			iRec167[0] = iRec167[1] * (1 - iTemp268) + iTemp265 * iTemp268;
			int iTemp269 = int(fSlow7 * (1.0f - float(iRec36)));
			iRec168[0] = iTemp269 * iTemp65 + iRec168[1] * iVec0[1];
			int iTemp270 = (iRec67[0] + iRec168[0]) % iSlow4;
			...
			iRec170[0] = iRec170[1] * iVec0[1] + iTemp273 * iTemp65;
			int iTemp274 = (iRec67[0] + iRec170[0]) % iSlow4;
			float fTemp275 = float(iTemp274);
			int iTemp276 = int(fSlow6 * fTemp275);
			iRec171[0] = iRec171[1] * (1 - iTemp276) + iTemp273 * iTemp276;
			int iTemp277 = int(fSlow7 * (1.0f - float(iRec40)));
			iRec172[0] = iRec172[1] * iVec0[1] + iTemp277 * iTemp65;
			int iTemp278 = (iRec67[0] + iRec172[0]) % iSlow4;
			float fTemp279 = float(iTemp278);
			int iTemp280 = int(fSlow6 * fTemp279);
			iRec173[0] = iRec173[1] * (1 - iTemp280) + iTemp277 * iTemp280;
			int iTemp281 = int(fSlow7 * (1.0f - float(iRec30)));
			iRec174[0] = iRec174[1] * iVec0[1] + iTemp281 * iTemp65;
			int iTemp282 = (iRec67[0] + iRec174[0]) % iSlow4;
			float fTemp283 = float(iTemp282);
			int iTemp284 = int(fSlow6 * fTemp283);
			iRec175[0] = iRec175[1] * (1 - iTemp284) + iTemp281 * iTemp284;
			int iTemp285 = int(fSlow7 * (1.0f - float(iRec32)));
			iRec176[0] = iRec176[1] * iVec0[1] + iTemp285 * iTemp65;
			int iTemp286 = (iRec67[0] + iRec176[0]) % iSlow4;
			float fTemp287 = float(iTemp286);
			int iTemp288 = int(fSlow6 * fTemp287);
			iRec177[0] = iRec177[1] * (1 - iTemp288) + iTemp285 * iTemp288;
			int iTemp289 = int(fSlow7 * (1.0f - float(iRec34)));
			iRec178[0] = iRec178[1] * iVec0[1] + iTemp289 * iTemp65;
			int iTemp290 = (iRec67[0] + iRec178[0]) % iSlow4;
			float fTemp291 = float(iTemp290);
			int iTemp292 = int(fSlow6 * fTemp291);
			iRec179[0] = iRec179[1] * (1 - iTemp292) + iTemp289 * iTemp292;
			int iTemp293 = int(fSlow7 * (1.0f - float(iRec22)));
			iRec180[0] = iRec180[1] * iVec0[1] + iTemp293 * iTemp65;
			int iTemp294 = (iRec67[0] + iRec180[0]) % iSlow4;
			float fTemp295 = float(iTemp294);
			int iTemp296 = int(fSlow6 * fTemp295);
			iRec181[0] = iRec181[1] * (1 - iTemp296) + iTemp293 * iTemp296;
			int iTemp297 = int(fSlow7 * (1.0f - float(iRec24)));
			iRec182[0] = iRec182[1] * iVec0[1] + iTemp297 * iTemp65;
			int iTemp298 = (iRec67[0] + iRec182[0]) % iSlow4;
			float fTemp299 = float(iTemp298);
			int iTemp300 = int(fSlow6 * fTemp299);
			iRec183[0] = iRec183[1] * (1 - iTemp300) + iTemp297 * iTemp300;
			int iTemp301 = int(fSlow7 * (1.0f - float(iRec26)));
			iRec184[0] = iRec184[1] * iVec0[1] + iTemp301 * iTemp65;
			int iTemp302 = (iRec67[0] + iRec184[0]) % iSlow4;
			float fTemp303 = float(iTemp302);
			int iTemp304 = int(fSlow6 * fTemp303);
			iRec185[0] = iRec185[1] * (1 - iTemp304) + iTemp301 * iTemp304;
			int iTemp305 = int(fSlow7 * (1.0f - float(iRec28)));
			iRec186[0] = iRec186[1] * iVec0[1] + iTemp305 * iTemp65;
			int iTemp306 = (iRec67[0] + iRec186[0]) % iSlow4;
			float fTemp307 = float(iTemp306);
			int iTemp308 = int(fSlow6 * fTemp307);
			iRec187[0] = iRec187[1] * (1 - iTemp308) + iTemp305 * iTemp308;
			int iTemp309 = int(fSlow7 * (1.0f - float(iRec16)));
			iRec188[0] = iRec188[1] * iVec0[1] + iTemp309 * iTemp65;
			int iTemp310 = (iRec67[0] + iRec188[0]) % iSlow4;
			float fTemp311 = float(iTemp310);
			int iTemp312 = int(fSlow6 * fTemp311);
			iRec189[0] = iRec189[1] * (1 - iTemp312) + iTemp309 * iTemp312;
			int iTemp313 = int(fSlow7 * (1.0f - float(iRec18)));
			iRec190[0] = iRec190[1] * iVec0[1] + iTemp313 * iTemp65;
			int iTemp314 = (iRec67[0] + iRec190[0]) % iSlow4;
			float fTemp315 = float(iTemp314);
			int iTemp316 = int(fSlow6 * fTemp315);
			iRec191[0] = iRec191[1] * (1 - iTemp316) + iTemp313 * iTemp316;
			int iTemp317 = int(fSlow7 * (1.0f - float(iRec20)));
			iRec192[0] = iRec192[1] * iVec0[1] + iTemp317 * iTemp65;
			int iTemp318 = (iRec67[0] + iRec192[0]) % iSlow4;
			float fTemp319 = float(iTemp318);
			int iTemp320 = int(fSlow6 * fTemp319);
			iRec193[0] = iRec193[1] * (1 - iTemp320) + iTemp317 * iTemp320;
			output1[i0] = FAUSTFLOAT(fSlow1 * (fSlow40 * std::sin(fSlow8 * fTemp195) * ftbl0[std::max<int>(0, std::min<int>((iTemp194 + iRec131[0]) % iSlow3, 479999))] + fSlow41 * std::sin(fSlow8 * fTemp199) * ftbl0[std::max<int>(0, std::min<int>((iTemp198 + iRec133[0]) % iSlow3, 479999))] + fSlow42 * std::sin(fSlow8 * fTemp203) * ftbl0[std::max<int>(0, std::min<int>((iTemp202 + iRec135[0]) % iSlow3, 479999))] + fSlow43 * std::sin(fSlow8 * fTemp207) * ftbl0[std::max<int>(0, std::min<int>((iTemp206 + iRec137[0]) % iSlow3, 479999))] + fSlow44 * std::sin(fSlow8 * fTemp211) * ftbl0[std::max<int>(0, std::min<int>((iTemp210 + iRec139[0]) % iSlow3, 479999))] + fSlow45 * std::sin(fSlow8 * fTemp215) * ftbl0[std::max<int>(0, std::min<int>((iTemp214 + iRec141[0]) % iSlow3, 479999))] + fSlow46 * std::sin(fSlow8 * fTemp219) * ftbl0[std::max<int>(0, std::min<int>((iTemp218 + iRec143[0]) % iSlow3, 479999))] + fSlow47 * std::sin(fSlow8 * fTemp223) * ftbl0[std::max<int>(0, std::min<int>((iTemp222 + iRec145[0]) % iSlow3, 479999))] + fSlow48 * std::sin(fSlow8 * fTemp227) * ftbl0[std::max<int>(0, std::min<int>((iTemp226 + iRec147[0]) % iSlow3, 479999))] + fSlow49 * std::sin(fSlow8 * fTemp231) * ftbl0[std::max<int>(0, std::min<int>((iTemp230 + iRec149[0]) % iSlow3, 479999))] + fSlow50 * std::sin(fSlow8 * fTemp235) * ftbl0[std::max<int>(0, std::min<int>((iTemp234 + iRec151[0]) % iSlow3, 479999))] + fSlow51 * std::sin(fSlow8 * fTemp239) * ftbl0[std::max<int>(0, std::min<int>((iTemp238 + iRec153[0]) % iSlow3, 479999))] + fSlow52 * std::sin(fSlow8 * fTemp243) * ftbl0[std::max<int>(0, std::min<int>((iTemp242 + iRec155[0]) % iSlow3, 479999))] + fSlow53 * ftbl0[std::max<int>(0, std::min<int>((iTemp246 + iRec157[0]) % iSlow3, 479999))] * std::sin(fSlow8 * fTemp247) + fSlow54 * ftbl0[std::max<int>(0, std::min<int>((iTemp250 + iRec159[0]) % iSlow3, 479999))] * std::sin(fSlow8 * fTemp251) + fSlow55 * ftbl0[std::max<int>(0, std::min<int>((iTemp254 + iRec161[0]) % iSlow3, 479999))] * std::sin(fSlow8 * fTemp255) + fSlow56 * ftbl0[std::max<int>(0, std::min<int>((iTemp258 + iRec163[0]) % iSlow3, 479999))] * std::sin(fSlow8 * fTemp259) + fSlow57 * ftbl0[std::max<int>(0, std::min<int>((iTemp262 + iRec165[0]) % iSlow3, 479999))] * std::sin(fSlow8 * fTemp263) + fSlow58 * ftbl0[std::max<int>(0, std::min<int>((iTemp266 + iRec167[0]) % iSlow3, 479999))] * std::sin(fSlow8 * fTemp267) + fSlow59 * ftbl0[std::max<int>(0, std::min<int>((iTemp270 + iRec169[0]) % iSlow3, 479999))] * std::sin(fSlow8 * fTemp271) + fSlow60 * ftbl0[std::max<int>(0, std::min<int>((iTemp274 + iRec171[0]) % iSlow3, 479999))] * std::sin(fSlow8 * fTemp275) + fSlow61 * ftbl0[std::max<int>(0, std::min<int>((iTemp278 + iRec173[0]) % iSlow3, 479999))] * std::sin(fSlow8 * fTemp279) + fSlow62 * ftbl0[std::max<int>(0, std::min<int>((iTemp282 + iRec175[0]) % iSlow3, 479999))] * std::sin(fSlow8 * fTemp283) + fSlow63 * ftbl0[std::max<int>(0, std::min<int>((iTemp286 + iRec177[0]) % iSlow3, 479999))] * std::sin(fSlow8 * fTemp287) + fSlow64 * ftbl0[std::max<int>(0, std::min<int>((iTemp290 + iRec179[0]) % iSlow3, 479999))] * std::sin(fSlow8 * fTemp291) + fSlow65 * ftbl0[std::max<int>(0, std::min<int>((iTemp294 + iRec181[0]) % iSlow3, 479999))] * std::sin(fSlow8 * fTemp295) + fSlow66 * ftbl0[std::max<int>(0, std::min<int>((iTemp298 + iRec183[0]) % iSlow3, 479999))] * std::sin(fSlow8 * fTemp299) + fSlow67 * ftbl0[std::max<int>(0, std::min<int>((iTemp302 + iRec185[0]) % iSlow3, 479999))] * std::sin(fSlow8 * fTemp303) + fSlow68 * ftbl0[std::max<int>(0, std::min<int>((iTemp306 + iRec187[0]) % iSlow3, 479999))] * std::sin(fSlow8 * fTemp307) + fSlow69 * ftbl0[std::max<int>(0, std::min<int>((iTemp310 + iRec189[0]) % iSlow3, 479999))] * std::sin(fSlow8 * fTemp311) + fSlow70 * ftbl0[std::max<int>(0, std::min<int>((iTemp314 + iRec191[0]) % iSlow3, 479999))] * std::sin(fSlow8 * fTemp315) + fSlow71 * ftbl0[std::max<int>(0, std::min<int>((iTemp318 + iRec193[0]) % iSlow3, 479999))] * std::sin(fSlow8 * fTemp319)));
			iVec0[1] = iVec0[0];
			iRec0[1] = iRec0[0];
			iRec3[1] = iRec3[0];
			iRec2[1] = iRec2[0];
