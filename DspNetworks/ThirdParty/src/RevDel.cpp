...
struct _RevDel final : public ::faust::dsp {
	...
	void instanceConstants(int sample_rate) {
		...
		fConst38 = 5.0f / fConst0;
		fConst39 = std::tan(109.95574f / fConst0);
		...
		fConst59 = 2.5f / fConst0;
		fConst60 = std::tan(62.831852f / fConst0);
	...
	void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			fRec7[0] = fConst26 * (fConst28 * fRec8[2] + fConst28 * fRec8[0] + fConst31 * fRec8[1]) - fConst24 * (fConst32 * fRec7[2] + fConst33 * fRec7[1]);
			...
			fRec12[0] = 3.259629e-09f * fTemp0 - fConst47 * (fConst50 * fRec12[2] + fConst51 * fRec12[1]);
			...
			fRec16[0] = 9.313226e-09f * fTemp0 - fConst68 * (fConst71 * fRec16[2] + fConst72 * fRec16[1]);
